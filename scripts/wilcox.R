...
wilcox.test(pData(microbiome_analytic_data[[1]])$microbiome_family_Richness ~ pData(microbiome_analytic_data[[1]])$Treatment)
wilcox.test(pData(microbiome_analytic_data[[1]])$microbiome_family_Shannon ~ pData(microbiome_analytic_data[[1]])$Treatment)

wilcox.test(pData(microbiome_analytic_data[[1]])$microbiome_genus_Richness ~ pData(microbiome_analytic_data[[1]])$Treatment)
wilcox.test(pData(microbiome_analytic_data[[1]])$microbiome_genus_Shannon ~ pData(microbiome_analytic_data[[1]])$Treatment)

wilcox.test(pData(microbiome_analytic_data[[1]])$microbiome_species_Richness ~ pData(microbiome_analytic_data[[1]])$Treatment)
wilcox.test(pData(microbiome_analytic_data[[1]])$microbiome_species_Shannon ~ pData(microbiome_analytic_data[[1]])$Treatment)
